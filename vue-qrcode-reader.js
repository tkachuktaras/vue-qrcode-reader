import { defineComponent as jt, ref as we, watch as We, onMounted as vo, onUnmounted as yo, computed as It, openBlock as Lt, createElementBlock as Ht, createElementVNode as nt, normalizeStyle as go, withDirectives as wo, vShow as bo, renderSlot as Dr, withModifiers as at } from "vue";
var Mr = (r, o, i) => {
  if (!o.has(r))
...
}, $o = (r, o, i, c) => (Mr(r, o, "write to private field"), c ? c.call(r, i) : o.set(r, i), i);
const Ar = [
  ["aztec", "Aztec"],
  ["code_128", "Code128"],
  ["code_39", "Code39"],
...
], _o = [...Ar, ["unknown"]].map((r) => r[0]), ot = new Map(
  Ar
);
function So(r) {
  for (const [o, i] of ot)
...
async function Mo(r) {
  ...
  return Fr(r) || Ur(r) ? Do(r) : await Lr(r);
}
async function Ao(r) {
  try {
...
var ut = (() => {
  ...
  return function(o = {}) {
    ...
    var I;
    i.wasmBinary && (I = i.wasmBinary), typeof WebAssembly != "object" && Z("no native wasm support detected");
    ...
    var mt = "data:application/octet-stream;base64,", He = (e) => e.startsWith(mt), fe;
    ...
    function vt(e) {
      return !I && (g || b) && typeof fetch == "function" ? fetch(e, {
    ...
    function on() {
      ...
      function t(a, s) {
        return z = a.exports, U = z.ia, be(), Kt = z.ma, ht(z.ja), de(), z;
      }
      pt();
      function n(a) {
        t(a.instance);
    ...
    var $e = {}, ye = {}, Ge = {}, qt, Ye = (e) => {
      ...
      ge([e], u, (d) => {
        ...
        return s.forEach((m, w) => {
          var _ = m.fieldName, T = d[w], E = m.getter, O = m.getterContext, L = d[w + s.length], q = m.setter, F = m.setterContext;
          f[_] = {
            read: (J) => T.fromWireType(E(O, J)),
            write: (J, y) => {
              var P = [];
              q(F, J, L.toWireType(P, y)), bt(P);
            }
          };
        }), [{
          name: t.name,
    ...
    var ke = (e) => typeof FinalizationRegistry > "u" ? (ke = (t) => t, e) : (_t = new FinalizationRegistry((t) => {
      ...
      Object.assign(Qe.prototype, {
        ...
        deleteLater() {
          return this.$$.ptr || $t(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), Ae.push(this), Ae.length === 1 && xe && xe(St), this.$$.deleteScheduled = !0, this;
        }
      });
    };
    function Qe() {
    }
    var Fe = (e, t) => Object.defineProperty(t, "name", {
      value: e
    }), Qt = (e, t, n) => {
    ...
    function Fn(e, t) {
      ...
      t.$$ || x(`Cannot pass "${At(t)}" as a ${this.name}`), t.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function In(e, t) {
      ...
      (!t || !t.$$) && x(`Cannot pass "${At(t)}" as a ${this.name}`), t.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && t.$$.ptrType.isConst && x(`Cannot convert argument of type ${t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name} to parameter type ${this.name}`);
    ...
    function Un(e, t) {
      if (t === null)
        return this.isReference && x(`null is not a valid ${this.name}`), 0;
      t.$$ || x(`Cannot pass "${At(t)}" as a ${this.name}`), t.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`), t.$$.ptrType.isConst && x(`Cannot convert argument of type ${t.$$.ptrType.name} to parameter type ${this.name}`);
      var n = t.$$.ptrType.registeredClass, a = Tt(t.$$.ptr, n, this.registeredClass);
      return a;
    }
    function Xt(e) {
    ...
    function Xe(e, t, n, a, s, u, d, f, m, w, _) {
      this.name = e, this.registeredClass = t, this.isReference = n, this.isConst = a, this.isSmartPointer = s, this.pointeeType = u, this.sharingPolicy = d, this.rawGetPointee = f, this.rawConstructor = m, this.rawShare = w, this.rawDestructor = _, !s && t.baseClass === void 0 ? a ? (this.toWireType = Fn, this.destructorFunction = null) : (this.toWireType = Un, this.destructorFunction = null) : this.toWireType = In;
    }
    var Zt = (e, t, n) => {
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Pt(O, function() {
        ...
        L = L[0];
        var q, F;
        a ? (q = L.registeredClass, F = q.instancePrototype) : F = Qe.prototype;
        var J = Fe(_, function() {
    ...
    function Ot(e, t, n, a, s, u) {
      ...
      var f = t[1] !== null && n !== null, m = qn(t), w = t[0].name !== "void", _ = d - 2, T = new Array(_), E = [], O = [], L = function() {
        ...
        for (var F = 0; F < _; ++F)
          T[F] = t[F + 2].toWireType(O, arguments[F]), E.push(T[F]);
    ...
    var Nn = (e, t, n, a, s, u) => {
      ...
      t = Y(t), t = rr(t), u = ee(s, u), ge([], [e], function(_) {
        ...
        return L === void 0 || L.overloadTable === void 0 && L.className !== _.name && L.argCount === n - 2 ? (E.argCount = n - 2, E.className = _.name, O[t] = E) : (Qt(O, t, T), O[t].overloadTable[n - 2] = E), ge([], w, function(q) {
          var F = Ot(T, q, _, u, d);
          return O[t].overloadTable === void 0 ? (F.argCount = n - 2, O[t] = F) : O[t].overloadTable[n - 2] = F, [];
        }), [];
      });
    };
    function Gn() {
    ...
    var K = new nr(), Dt = (e) => {
    ...
    }, Rt = [], wa = (e, t, n, a) => (e = Rt[e], t = se.toValue(t), e(null, t, n, a)), ba = {}, Ca = (e) => {
      var t = ba[e];
      ...
      var u = new Array(e), d = (m, w, _, T) => {
        ...
        for (var L = n === 1 ? Pa(w, u) : w.apply(m, u), O = 0; O < e; ++O) {
          var q, F;
          (q = (F = a[O]).deleteObject) === null || q === void 0 || q.call(F, u[O]);
        }
        return Ta(s, _, L);
...
`,
      ...
      d = d.replace(/%%/g, "\0\0");
      for (var m in F)
        d.includes(m) && (d = d.replace(new RegExp(m, "g"), F[m](u)));
      d = d.replace(/\0\0/g, "%");
      var J = Va(d, !1);
    ...
    function yr() {
      if (te > 0 || (Le(), te > 0))
        return;
      function e() {
        tt || (tt = !0, i.calledRun = !0, !W && (lt(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), dt()));
      }
  ...
  async detect(o) {
    try {
      ...
      try {
        jr(i) ? c = await Jo(i, {
          tryHarder: !0,
          formats: br(this, je).map((l) => ot.get(l))
        }) : c = await Qo(i, {
          tryHarder: !0,
          formats: br(this, je).map((l) => ot.get(l))
        });
      ...
      return c.map((l) => {
        const {
          ...
          bottomLeft: { x: p, y: C },
          bottomRight: { x: S, y: $ }
        } = l.position, I = Math.min(h, g, p, S), U = Math.min(v, b, C, $), W = Math.max(h, g, p, S), R = Math.max(v, b, C, $);
        return {
...
async function ei(r) {
  if (window.BarcodeDetector === void 0)
    return console.debug("[vue-qrcode-reader] Native BarcodeDetector not supported. Will use polyfill."), new st({ formats: r });
  const o = await window.BarcodeDetector.getSupportedFormats(), i = r.filter((c) => !o.includes(c));
  return i.length > 0 ? (console.debug(`[vue-qrcode-reader] Native BarcodeDetector does not support formats ${JSON.stringify(i)}. Will use polyfill.`), new st({ formats: r })) : (console.debug("[vue-qrcode-reader] Will use native BarcodeDetector."), new window.BarcodeDetector({ formats: r }));
}
async function Nr(r) {
  qr = await ei(r);
}
...
}, zr = async (r, o = ["qr_code"]) => await new st({ formats: o }).detect(r), ni = async (r, o = ["qr_code"]) => {
  const i = new st({ formats: o }), c = await ri(r);
...
function hi(r) {
  ...
  if (i.mozGetUserMedia)
    o.browser = "firefox", o.version = it(i.userAgent, /Firefox\/(\d+)\./, 1);
  else if (i.webkitGetUserMedia || r.isSecureContext === !1 && r.webkitRTCPeerConnection)
    o.browser = "chrome", o.version = it(i.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
  else if (r.RTCPeerConnection && i.userAgent.match(/AppleWebKit\/(\d+)\./))
    o.browser = "safari", o.version = it(i.userAgent, /AppleWebKit\/(\d+)\./, 1), o.supportsUnifiedPlan = r.RTCRtpTransceiver && "currentDirection" in r.RTCRtpTransceiver.prototype;
  else
  ...
  if (i.mediaDevices) {
    var c = function(p) {
      ...
      return Object.keys(p).forEach(function(S) {
        if (!(S === "require" || S === "advanced" || S === "mediaSource")) {
          ...
          if ($.ideal !== void 0) {
            ...
            var U = {};
            typeof $.ideal == "number" ? (U[I("min", S)] = $.ideal, C.optional.push(U), U = {}, U[I("max", S)] = $.ideal, C.optional.push(U)) : (U[I("", S)] = $.ideal, C.optional.push(U));
          }
          $.exact !== void 0 && typeof $.exact != "number" ? (C.mandatory = C.mandatory || {}, C.mandatory[I("", S)] = $.exact) : ["min", "max"].forEach(function(W) {
            $[W] !== void 0 && (C.mandatory = C.mandatory || {}, C.mandatory[I(W, S)] = $[W]);
          });
        }
      ...
      if (p && he(p.video) === "object") {
        ...
        var I = o.version < 66;
        if ($ && ($.exact === "user" || $.exact === "environment" || $.ideal === "user" || $.ideal === "environment") && !(i.mediaDevices.getSupportedConstraints && i.mediaDevices.getSupportedConstraints().facingMode && !I)) {
      ...
      l(p, function($) {
        i.webkitGetUserMedia($, C, function(I) {
          S && S(h(I));
        });
      });
    };
  ...
  setup(r, { emit: o }) {
    ...
    We(
      ...
      async (k) => {
        ...
        if (ue(le !== null, "if cavnas is defined, canvas 2d context should also be non-null"), k.shouldStream)
          try {
            const oe = await Fi(D, k);
            C.value ? (p.value = !0, c("camera-on", oe)) : await Ut();
          } catch (oe) {
            c("error", oe);
          }
        else
          M.width = D.videoWidth, M.height = D.videoHeight, le.drawImage(D, 0, 0, D.videoWidth, D.videoHeight), Ut(), p.value = !1, c("camera-off");
      },
      { deep: !0 }
    ), We(h, async (k) => {
      C.value && await Nr(k);
    });
    const $ = It(() => S.value.shouldStream && p.value);
    We($, (k) => {
      if (k) {
        ue(
          v.value !== void 0,
    ...
    const I = (k) => {
      ...
      if (ue(
        ...
        const le = M.offsetWidth, oe = M.offsetHeight, be = M.videoWidth, Ce = M.videoHeight, Oe = Math.max(le / be, oe / Ce), De = be * Oe, Le = Ce * Oe, lt = De / be, dt = Le / Ce, ft = (le - De) / 2, ht = (oe - Le) / 2, Me = ({ x: de, y: Z }) => ({
          x: Math.floor(de * lt),
          y: Math.floor(Z * dt)
        }), te = ({ x: de, y: Z }) => ({
          x: Math.floor(de + ft),
          ...
          const { boundingBox: Z, cornerPoints: mt } = de, { x: He, y: fe } = te(
            Me({
              x: Z.x,
              y: Z.y
            })
          ...
          return {
            ...de,
            cornerPoints: mt.map((Ve) => te(Me(Ve))),
            boundingBox: DOMRectReadOnly.fromRect({ x: He, y: fe, width: Be, height: vt })
          };
        });
        D.width = M.offsetWidth, D.height = M.offsetHeight;
        const pt = D.getContext("2d");
        i.track(ve, pt);
      }
    }, W = {
      width: "100%",
...
function ji(r) {
  r.component("qrcode-stream", Ii), r.component("qrcode-capture", Ui), r.component("qrcode-drop-zone", Wi);
}
const Bi = { install: ji };
export {
  Ui as QrcodeCapture,
